...
Position records SHOULD identify the stance, practical basis, known tradeoffs, relevant standards/research, and any deliberate divergence from common industry practice.

Do not erase a documented preference merely because a framework/vendor recommends another pattern.
