...
Agents MUST preserve source citation, publication date, method/population when material, findings, limitations, and applicability.

Do not convert one paper, survey, blog post, or benchmark into a universal README contract without an explicit synthesis/adoption step.
