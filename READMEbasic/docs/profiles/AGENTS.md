...
Agents MUST preserve the distinction between profile-specific priorities and framework-wide integrity/evidence rules.

Do not add sections merely because another profile uses them. Do not remove material status, setup, limitation, support, or governance information when it is necessary for the actual audience.
