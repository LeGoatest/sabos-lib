...
3. Keep raw values in `src/foundation/tokens.css` and semantic Tailwind mappings in `src/foundation/theme.css`.
...
7. Update documentation and `CHANGELOG.md` when changing the public class API.
