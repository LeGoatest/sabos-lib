...
- `docs/discovery/generative-engine-optimization.md` defining GEO around generative retrieval/source selection, citation, representation, experimental source-influence research constructs, referrals and conversion while preserving the foundational KDD 2024 GEO research and its benchmark/domain limitations.
