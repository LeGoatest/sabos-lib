...
- verify current platform behavior/policies when recommendations depend on changing ad systems;
- distinguish paid search from paid social and from organic social;
- distinguish platform-reported conversions from independently verified business outcomes where the difference matters;
- connect campaign structure, targeting, creative, and landing-page behavior to the stated objective;
- preserve geographic/service eligibility and truthful offer constraints;
- state attribution and measurement limitations.

Agents MUST NOT:

- guarantee ROAS, CPA, rankings, lead volume, or conversion rates;
