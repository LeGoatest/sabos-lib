...
- Prefer primary research or authoritative datasets when available.
...
- Record meaningful limitations, sample constraints, conflicts of interest, or methodology caveats.
...
- cite a headline without checking the underlying study when material;
- turn one study into universal law;
- omit contrary evidence merely because it challenges an existing preference;
